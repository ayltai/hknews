...
public final class HkejRealtimeParserTests extends ParserTests {
    ...
    public void testGetItems() throws Exception {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hkej_realtime_list.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://www2.hkej.com/instantnews/current");

            final Collection<Item> items = new HkejRealtimeParser("信報即時", this.sourceService, service, Mockito.mock(LambdaLogger.class)).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hkej_realtime_details.html"), StandardCharsets.UTF_8);
             BufferedReader    bufferedReader    = new BufferedReader(inputStreamReader)) {
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://www2.hkej.com/instantnews/current/article/2552130/%E7%89%B9%E9%A6%96%E5%A7%94%E4%BB%BB%E6%9E%97%E5%A4%A7%E8%BC%9D%E7%82%BA%E9%A6%99%E6%B8%AF%E9%9B%BB%E5%8F%B0%E9%A1%A7%E5%95%8F%E5%A7%94%E5%93%A1%E6%9C%83%E4%B8%BB%E5%B8%AD");
            ...
            final Item updatedItem = new HkejRealtimeParser("信報即時", this.sourceService, service, Mockito.mock(LambdaLogger.class)).updateItem(item);
