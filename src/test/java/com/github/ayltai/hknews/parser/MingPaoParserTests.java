...
public final class MingPaoParserTests extends ParserTests {
    ...
    public void testGetItems() throws Exception {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/mingpao.xml"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(new XmlMapper().readValue(bufferedReader.lines().collect(Collectors.joining("\n")), Root.class)).when(service).getRss(ArgumentMatchers.anyString());

            final Collection<Item> items = new ScmpParser("明報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/mingpao.html"), StandardCharsets.UTF_8);
             BufferedReader    bufferedReader    = new BufferedReader(inputStreamReader)) {
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://news.mingpao.com/pns/%e6%b8%af%e8%81%9e/article/20200808/s00002/1596825748734/%e5%85%a8%e6%b0%91%e8%87%aa%e9%a1%98%e9%a9%97-%e6%9e%97%e9%84%ad%e8%aa%8d%e7%84%a1%e7%a6%81%e8%b6%b3%e6%88%90%e6%95%88%e6%89%93%e6%8a%98-%e6%b6%89%e6%ac%be%e6%96%99%e5%8f%af%e9%81%9424%e5%84%84-3%e5%85%a7%e5%9c%b0%e6%a9%9f%e6%a7%8b%e6%89%bf%e5%8c%85");
            ...
            final Item updatedItem = new MingPaoParser("明報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).updateItem(item);
