...
public final class HeadlineParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/headline_list.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://hd.stheadline.com/news/daily/hk/%E6%97%A5%E5%A0%B1-%E6%B8%AF%E8%81%9E/");

            final Collection<Item> items = new HeadlineParser("頭條日報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/headline_details.html"), StandardCharsets.UTF_8);
             BufferedReader    bufferedReader    = new BufferedReader(inputStreamReader)) {
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://hd.stheadline.com/news/daily/hk/874104/%E6%97%A5%E5%A0%B1-%E6%B8%AF%E8%81%9E-%E5%85%A8%E6%B0%91%E5%85%8D%E8%B2%BB%E6%AA%A2%E6%B8%AC-%E6%9C%80%E5%BF%AB%E5%85%A9%E5%91%A8%E5%BE%8C%E5%B1%95%E9%96%8B");
            ...
            final Item updatedItem = new HeadlineParser("頭條日報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).updateItem(item);
