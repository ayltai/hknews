...
public final class HkejParserTests extends ParserTests {
    ...
    public void testGetItems() throws Exception {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hkej_list.html"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new HkejParser("信報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hkej_details.html"), StandardCharsets.UTF_8);
             BufferedReader    bufferedReader    = new BufferedReader(inputStreamReader)) {
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://www1.hkej.com/dailynews/views/article/2551793/%E5%85%A7%E5%9C%B0%E5%AE%A2%E7%B6%93%E6%B8%AF%E8%BD%89%E6%A9%9F%E6%81%A2%E5%BE%A9+%E7%A9%BA%E6%9C%8D%E5%93%A1%E6%86%82%E6%92%AD%E6%AF%92");
            ...
            final Item updatedItem = new HkejParser("信報", this.sourceService, service, Mockito.mock(LambdaLogger.class)).updateItem(item);
