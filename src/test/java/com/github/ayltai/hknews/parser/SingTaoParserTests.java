...
public final class SingTaoParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/singtao_list.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(call).when(service).getHtml("https://std.stheadline.com/daily/hongkong/%E6%97%A5%E5%A0%B1-%E6%B8%AF%E8%81%9E");
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/singtao_realtime_list.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(call).when(service).getHtml("https://std.stheadline.com/realtime/hongkong/%E5%8D%B3%E6%99%82-%E6%B8%AF%E8%81%9E");
            Mockito.doReturn(response).when(call).execute();
        }

        final Collection<Item> items = new SingTaoParser("星島日報", this.sourceRepository, factory).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/singtao_details.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(call).when(service).getHtml("https://std.stheadline.com/daily/article/2264439/%E6%97%A5%E5%A0%B1-%E6%B8%AF%E8%81%9E-%E9%BB%8E%E6%99%BA%E8%8B%B1-%E5%B0%B1%E7%AE%97%E5%9D%90%E7%9B%A3%E4%BA%A6%E6%8F%80%E5%91%A2%E6%A2%9D%E8%B7%AF");
            Mockito.doReturn(response).when(call).execute();
            ...
            final Item updatedItem = new SingTaoParser("星島日報", this.sourceRepository, factory).updateItem(item);
            ...
            Assertions.assertEquals("https://image.stheadline.com/f/1500p0/0x0/100/none/785c3fa74a96c7257e7cfb96055d7dba/stheadline/news_res/2020/08/13/646188/i_src_332480307.jpg", updatedItem.getImages().get(0).getImageUrl(), "Incorrect image URL");
        }
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/singtao_realtime_details.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(call).when(service).getHtml("https://std.stheadline.com/realtime/article/1340377/%E5%8D%B3%E6%99%82-%E6%B8%AF%E8%81%9E-%E6%9C%AC%E6%B8%AF%E5%A2%9E89%E5%AE%97%E7%A2%BA%E8%A8%BA32%E5%AE%97%E6%BA%90%E9%A0%AD%E4%B8%8D%E6%98%8E-%E7%9B%B4%E9%8A%B7%E5%85%AC%E5%8F%B8%E7%BE%A4%E7%B5%84%E5%86%8D%E5%A4%9A5%E5%AE%97");
            Mockito.doReturn(response).when(call).execute();
            ...
            Assertions.assertEquals("https://image.stheadline.com/f/1500p0/0x0/100/st/629b3ec9e7547d1ca769907d127a3c49/stheadline/inewsmedia/20200807/_2020080716424135741.jpg", updatedItem.getImages().get(0).getImageUrl(), "Incorrect image URL");
        }
    }
}
