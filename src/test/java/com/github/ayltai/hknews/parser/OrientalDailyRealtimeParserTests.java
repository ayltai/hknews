...
public final class OrientalDailyRealtimeParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/orientaldaily_realtime_list.js"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new OrientalDailyRealtimeParser("東方即時", this.sourceService, factory, Mockito.mock(LambdaLogger.class)).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        final Item updatedItem = new OrientalDailyRealtimeParser("東方即時", this.sourceService, factory, Mockito.mock(LambdaLogger.class)).updateItem(item);
