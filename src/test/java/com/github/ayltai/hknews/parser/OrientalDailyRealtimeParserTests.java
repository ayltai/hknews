...
public final class OrientalDailyRealtimeParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/orientaldaily_realtime_list.js"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new OrientalDailyRealtimeParser("東方即時", this.sourceRepository, factory).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        final Item updatedItem = new OrientalDailyRealtimeParser("東方即時", this.sourceRepository, factory).updateItem(item);
        ...
        Assertions.assertEquals("https://hk.on.cc/hk/bkn/cnt/news/20200809/photo/bkn-20200809231616005-0809_00822_001_01b.jpg?20200809233314", updatedItem.getImages().get(0).getImageUrl(), "Incorrect image URL");
        Assertions.assertEquals(1, updatedItem.getVideos().size(), "Incorrect video count");
        Assertions.assertEquals("https://video-cdn.on.cc/Video/202008/ONS200810-14390-03-M_ipad.mp4", updatedItem.getVideos().get(0).getVideoUrl(), "Incorrect video URL");
        Assertions.assertEquals("https://hk.on.cc/hk/bkn/cnt/news/20200809/photo/bkn-20200809231616005-0809_00822_001_01p.jpg", updatedItem.getVideos().get(0).getImageUrl(), "Incorrect thumbnail URL");
    }
}
