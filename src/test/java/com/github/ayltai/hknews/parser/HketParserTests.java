...
public final class HketParserTests extends ParserTests {
    ...
    public void testGetItems() throws Exception {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hket.xml"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new HketParser("經濟日報", this.sourceRepository, factory).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/hket.html"), StandardCharsets.UTF_8);
            ...
            final Item updatedItem = new HketParser("經濟日報", this.sourceRepository, factory).updateItem(item);
            ...
            Assertions.assertEquals("https://static02-proxy.hket.com/res/v3/image/content/2715000/2719226/60bd95fb-4332-40a4-b93f-d9a940bb10c6_1024.jpg", updatedItem.getImages().get(0).getImageUrl(), "Incorrect image URL");
        }
    }
}
