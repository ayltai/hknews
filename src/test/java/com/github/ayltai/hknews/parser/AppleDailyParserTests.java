...
public final class AppleDailyParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/appledaily.json"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new AppleDailyParser("蘋果日報", this.sourceRepository, factory).getItems("港聞");
            ...
            Assertions.assertEquals("https://cloudfront-ap-northeast-1.images.arcpublishing.com/appledaily/67FLDQ62IU46RWZVEFY36XIPWU.jpg", item.getImages().get(0).getImageUrl(), "Incorrect image URL");
            Assertions.assertEquals(1, item.getVideos().size(), "Incorrect video count");
            Assertions.assertEquals("https://d2i91erehhsxi2.cloudfront.net/appledaily/2020/08/07/5f2da5dac9e77c0007f8a51c/20200807_int_03_nAD_w.mp4", item.getVideos().get(0).getVideoUrl(), "Incorrect video URL");
            Assertions.assertEquals("https://d87urpdhi5rdo.cloudfront.net/08-07-2020/t_06b7c281c7aa4ababbf911eda144d34c_name_1596825337_0d56.jpg", item.getVideos().get(0).getImageUrl(), "Incorrect video thumb URL");
        }
    }
}
