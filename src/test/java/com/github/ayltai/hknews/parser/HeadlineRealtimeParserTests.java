...
public final class HeadlineRealtimeParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/headline_realtime_list.html"), StandardCharsets.UTF_8);
            ...
            Mockito.doReturn(bufferedReader.lines().collect(Collectors.joining("\n"))).when(service).getHtml("https://hd.stheadline.com/news/realtime/hk/%E5%8D%B3%E6%99%82-%E6%B8%AF%E8%81%9E/");

            final Collection<Item> items = new HeadlineRealtimeParser("頭條即時", this.sourceService, service, Mockito.mock(LambdaLogger.class)).getItems("港聞");
