...
public final class HeadlineRealtimeParserTests extends ParserTests {
    ...
    public void testGetItems() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/headline_realtime_list.html"), StandardCharsets.UTF_8);
            ...
            final Collection<Item> items = new HeadlineRealtimeParser("頭條即時", this.sourceRepository, factory).getItems("港聞");
    ...
    public void testUpdateItem() throws IOException {
        ...
        try (InputStreamReader inputStreamReader = new InputStreamReader(this.getClass().getClassLoader().getResourceAsStream("testdata/headline_realtime_details.html"), StandardCharsets.UTF_8);
            ...
            final Item updatedItem = new HeadlineRealtimeParser("頭條即時", this.sourceRepository, factory).updateItem(item);
            ...
            Assertions.assertEquals("https://image2.stheadline.com/f/1500p0/0x0/100/hd/46e339a990456c63d6add431d0cdce78/stheadline/inewsmedia/20200808/_2020080812521731954.jpg", updatedItem.getImages().get(0).getImageUrl(), "Incorrect image URL");
        }
    }
}
