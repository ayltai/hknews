...
public final class OrientalDailyParser extends Parser {
    ...
    public OrientalDailyParser(@NotNull final String sourceName, @NotNull final SourceService sourceService, @NotNull final ContentServiceFactory contentServiceFactory) {
