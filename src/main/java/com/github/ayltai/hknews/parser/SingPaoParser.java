...
public final class SingPaoParser extends Parser {
    ...
    public SingPaoParser(@NonNull final String sourceName, @NonNull final SourceRepository sourceRepository, @NonNull final ContentServiceFactory contentServiceFactory) {
