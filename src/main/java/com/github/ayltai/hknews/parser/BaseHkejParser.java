...
public abstract class BaseHkejParser extends Parser {
    ...
    protected BaseHkejParser(@NotNull final String sourceName, @NotNull final SourceService sourceService, @NotNull final ContentServiceFactory contentServiceFactory) {
